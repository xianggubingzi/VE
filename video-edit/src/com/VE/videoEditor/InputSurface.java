 ...
 * surface. Calls to eglSwapBuffers() cause a frame of data to be sent to the
 * video encoder.
 */
public class InputSurface {
    ...
    private void eglSetup() {
        ...
        // Configure EGL for recordable and OpenGL ES 2.0. We want enough RGB
        // bits
        ...
        if (!EGL14.eglChooseConfig(mEGLDisplay, attribList, 0, mConfigs, 0,
        ...
        int[] attrib_list = { EGL14.EGL_CONTEXT_CLIENT_VERSION, 2,
                EGL14.EGL_NONE };
        mEGLContext = EGL14.eglCreateContext(mEGLDisplay, mConfigs[0],
    ...
    private void createEGLSurface() {
        ...
        mEGLSurface = EGL14.eglCreateWindowSurface(mEGLDisplay, mConfigs[0],
    ...
    public int getWidth() {
        int[] value = new int[1];
        EGL14.eglQuerySurface(mEGLDisplay, mEGLSurface, EGL14.EGL_WIDTH, value,
                0);
        return value[0];
    }
    ...
    public int getHeight() {
        int[] value = new int[1];
        EGL14.eglQuerySurface(mEGLDisplay, mEGLSurface, EGL14.EGL_HEIGHT,
                value, 0);
        return value[0];
    }
